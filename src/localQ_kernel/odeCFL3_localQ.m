    ...
    while(tspan(2) - t >= small * abs(tspan(2)))
      ...
      for i = 1 : numY
        [ ydot{i}, stepBound(i), schemeData ] = ...
                                    feval(schemeFuncCell{i}, t, y, schemeData, Q);
      ...
      for i = 1 : numY
        [ ydot{i}, stepBound(i), schemeData ] = ...
                                 feval(schemeFuncCell{i}, t1, y1, schemeData, Q);
      ...
      for i = 1 : numY
        [ ydot{i}, stepBound(i), schemeData ] = ...
                            feval(schemeFuncCell{i}, tHalf, yHalf, schemeData, Q);
      ...
      if(iscell(yHalf))
        ...
        yThreeHalf = yHalf;
        yThreeHalf(Q) = yHalf(Q) + deltaT * ydot{1};
      end
