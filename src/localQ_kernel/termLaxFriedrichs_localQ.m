function [ ydot, stepBound, schemeData ] = termLaxFriedrichs_localQ(t, y, schemeData, Q)

% Time taken to compute spatial derivative is 0.010366 
% Time taken to compute hamiltonian is 0.001962 
% Time taken to compute dissipation is 0.011921 
% Time taken by odeCFL3 Step-1 is 0.024927 
...
% Updated to handle vector level sets.  Ian Mitchell 11/23/04.
  ...
  switch(nargout(thisSchemeData.hamFunc))
    case 1
      ham = feval(thisSchemeData.hamFunc, t, data, derivC, thisSchemeData, Q);
    case { 2, -1 }
