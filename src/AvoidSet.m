classdef AvoidSet < handle
    ...
    properties
        ...
        occupancy_map_safety    % (array) occupancy map with -1 (obs) +1 (free)
        occupancy_map_plan      % (array) occupancy map with -1 (obs) +1 (free)
    ...
    methods
        ...
        function obj = AvoidSet(gridLow, gridUp, lowRealObs, upRealObs, ...
            ...
            obj.occupancy_map_plan   = ones(transpose(obj.N(1:2))); % everything is initially free for the planner
            obj.sensed_region        = -ones(transpose(obj.N(1:2))); % everything is unsensed
        ...
        function dataOut = computeAvoidSet(obj)
            ...
            if isempty(obj.occupancy_map_safety) || isempty(obj.gFMM)
                error("Need to sense something before I can compute avoid set!\n");
            end
            ...
            % array.
            obj.unionL_2D_FMM = compute_fmm_map(obj.gFMM, obj.occupancy_map_safety);
