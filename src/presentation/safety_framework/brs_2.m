...
h = plot(states(1, 2:152), states(2, 2:152), 'linewidth', 5, 'color', [170/255, 170/255, 170/255], 'linestyle', '-');
...
% BRS
[grid2D, Vx2D] = proj(g, Vx, [0 0 1], 0.5*pi);
[~, c] = contour(grid2D.xs{1}, grid2D.xs{2}, -Vx2D, [0, 0], 'r', 'linewidth', 3);
...
% Save the figure
saveas(f, '/Users/somil/Documents/Research/Projects/safe_navigation/safe_navigation/data/Presentation/figures_and_videos/safety_framework/brs_2.png')
